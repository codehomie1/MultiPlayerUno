...
const create = async ( game_title, ongoing, top_deck, top_discard, position ) => {
  return await db.one(
    "INSERT INTO games (game_title, ongoing, top_deck, top_discard, position) VALUES ($1, $2, $3, $4, $5) RETURNING id",
    [game_title, ongoing, top_deck, top_discard, position]
  );
};
