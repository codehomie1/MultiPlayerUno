(() => {
  var e = {
      ...
      481: function (e, t, s) {
        ...
        const r = s(385),
          ...
          h = s(373),
          l = s(552),
          d = (0, c.default)("engine.io-client:socket");
        class p extends u.Emitter {
          ...
          createTransport(e) {
            ...
            return d("options: %j", s), new r.transports[e](s);
          }
          open() {
            let e;
            if (
            ...
            try {
              ...
              return (
                d("error while creating transport: %s", e),
          ...
          probe(e) {
            ...
            const n = () => {
              s ||
                (d('probe transport "%s" opened', e),
                t.send([{ type: "ping", data: "probe" }]),
                t.once("packet", (n) => {
                  if (!s)
                    if ("pong" === n.type && "probe" === n.data) {
                      if (
                        (d('probe transport "%s" pong', e),
                        (this.upgrading = !0),
            ...
            const o = (s) => {
              ...
              (n.transport = t.name),
                r(),
                d('probe transport "%s" failed because of error: %s', e, s),
            ...
            function c(e) {
              t &&
                e.name !== t.name &&
                (d('"%s" works - aborting "%s"', e.name, t.name), r());
            }
            const u = () => {
          ...
          onPacket(e) {
            if (
              ...
              switch (
                (d('socket receive: type "%s", data "%s"', e.type, e.data),
          ...
          flush() {
            if (
              ...
              d("flushing %d packets in socket", e.length),
          ...
          getWritablePackets() {
            ...
            return (
              d("payload size is %d (max: %d)", e, this.maxPayload),
              this.writeBuffer
            );
          }
          write(e, t, s) {
        ...
        (t.Socket = p), (p.protocol = h.protocol);
      },
      870: function (e, t, s) {
        "use strict";
        var n =
              ...
              this.transport.ready.then(() => {
                this.transport.createBidirectionalStream().then((e) => {
                  const t = (0, i.createPacketDecoderStream)(
                    ...
                    n = (0, i.createPacketEncoderStream)();
      ...
      373: (e, t, s) => {
        ...
        function u(e, t) {
          ...
          let n = 0;
          for (let r = 0; r < t; r++)
            (s[r] = e[0][n++]), n === e[0].length && (e.shift(), (n = 0));
          return e.length && n < e[0].length && (e[0] = e[0].slice(n)), s;
        }
        (t.encodePayload = (e, t) => {
          const s = e.length,
            r = new Array(s);
                ...
                for (s.push(l); ; ) {
                  if (0 === n) {
                    ...
                    if (r > Math.pow(2, 21) - 1) {
                      d.enqueue(o.ERROR_PACKET);
                      break;
                    }
                    (i = r * Math.pow(2, 32) + t.getUint32(4)), (n = 3);
                  } else {
                    if (c(s) < i) break;
                    const e = u(s, i);
                    d.enqueue((0, r.decodePacket)(h ? e : a.decode(e), t)),
                      (n = 0);
                  }
                  if (0 === i || i > e) {
                    d.enqueue(o.ERROR_PACKET);
  ...
  (s.d = (e, t) => {
    ...
    (() => {
      const { io: e } = s(46);
      e().on("chat:message:0", (e) => {
        console.log({ payload: e });
      }),
        document.querySelector(".chat-submit-btn"),
        document
